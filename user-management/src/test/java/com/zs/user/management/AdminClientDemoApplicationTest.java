...
//		assertAdminEvents.assertEvent(realmId, OperationType.UPDATE, AdminEventPaths.roleResourcePath("role-a"), role, ResourceType.REALM_ROLE);
		assertTrue("should_add_realm_role",adminClient.addRealmRoles(Arrays.asList(role)));
	...
	public void should_add_client_role(){
		...
		// Check
		assertTrue("should_add_client_role",adminClient.addClientRoles(id,Arrays.asList(role)));
	}
